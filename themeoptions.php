...
class ThemeOptions {
	...
	function getOptionsSupported() {
		return array(
			...
			gettext('Exif') => array('order' => 7, 'key' => 'zpB_show_exif', 'type' => OPTION_TYPE_CHECKBOX, 'desc' => gettext_th("Show the EXIF Data on Image page. Remember you have to check EXIFs data you want to show on options>image>information EXIF.", 'zpBootstrap'))
		);
	}
